...
build() {
	...
	mkdir -p $pkgdir/usr/share/licenses/nvidia-utils/
	...
	install -m644 $srcdir/NVIDIA-Linux-${ARCH}-${pkgver}-pkg0/LICENSE $pkgdir/usr/share/licenses/nvidia-utils/ || return 1
